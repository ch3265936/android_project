...
public class ProfileFragment extends BaseFragment {
    ...
    private void share(){
        UMImage thub = new UMImage(getActivity(), R.mipmap.share_logo);
        String title = getString(R.string.share_title2) ;
        String content = getString(R.string.share_content2);
        UMWeb web = new UMWeb(ApiConstants.BASE_HOST+ApiConstants.SHAREWEB);
