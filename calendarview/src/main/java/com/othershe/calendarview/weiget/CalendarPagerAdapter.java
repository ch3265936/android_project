...
public class CalendarPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        view.MAXMUL =mAttrsBean.getMaxNum();
        view.setOnCalendarViewAdapter(item_layout, calendarViewAdapter);
        view.setDateList(CalendarUtil.getMonthDate(date[0], date[1], mAttrsBean.getSpecifyMap(), mAttrsBean.getStatusMap()), SolarUtil.getMonthDays(date[0], date[1]));
