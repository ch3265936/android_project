...
public class MonthView extends ViewGroup {
    ...
    private void setMaxMuL(int num) {
        MAXMUL = num;
    }

    private void setNowNumber(int num) {
        nowNumber = num;
    }
    ...
    public void setDateList(List<DateBean> dates, int currentMonthDays) {
        ...
        for (int i = 0; i < dates.size(); i++) {
            ...
            if (item_layout != 0 && calendarViewAdapter != null) {
                ...
                imageView = (AppCompatImageView) views[2];
            } else {
                ...
                imageView = (AppCompatImageView) view.findViewById(R.id.point);
            }
            ...
            if (mAttrsBean.getChooseType() == 1 && mAttrsBean.getMultiDates() != null) {
                for (int[] d : mAttrsBean.getMultiDates()) {
                    nowNumber =mAttrsBean.getMultiDates().size();
                    if (date.getType() == 1
                            && d[0] == date.getSolar()[0]
                            && d[1] == date.getSolar()[1]
                            && d[2] == date.getSolar()[2]) {
